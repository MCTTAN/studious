...
<head>
  ...
  <meta name="author" content="MCTTAN">
          ...
          <div class="container-fluid">
            <div class="header-wrap">
              ...
              <form class="form-header" action="" method="POST">
                ...
                <button class="au-btn--submit blue-gradient" type="submit">
              ...
              <div class="header-button">
                ...
                <div class="account-wrap">
                  <div class="account-item clearfix js-item-menu">
                    ...
                    <!-- PROFILE PICTURE -->
                    <div class="image">
                      <img src="https://github.com/MCTTAN/studious/blob/master/media/profile-picture-sample.png?raw=true" alt="My Profile Picture">
                    </div>

                    <div class="content">
                      <a class="js-acc-btn" href="#">Jane Doe</a>
                    </div>
                    ...
                    <div class="account-dropdown js-dropdown">
                      <div class="account-dropdown__body">
                        ...
                        <div class="account-dropdown__item">
                          <a href="profile-personal-sample.html">
                        ...
                        <div class="account-dropdown__footer" onclick="logout()">
                          <a href="">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div style="text-align: right">
                                  <p style="font-size: 14px;">Last Update:   April 14, 2020 @ 04:30:15 PM EST</p>
                                </div>
                                
                                <br>
                                
                                <h2 class="title-2" style="padding-left: 300px;">Creative Writing</h2>
                  ...
                  <embed src="" width="" height="">
								  ...
								  <h2 class="title-1" style="text-align: center;">How California Teacher Erin Gruwell Inspired a Generation of Writers</h2>
								  
								  <br>
								  
								  <img src="https://github.com/MCTTAN/studious/blob/master/media/freedom-writers.jpg?raw=true" style="display: block; margin-left: auto; margin-right: auto;">
...
The documentary release coincides with the book’s 20th anniversary. Gruwell is currently working with students to compile a whole new set of stories for a new generation of young writers.
    ...
    <script src="assets/js/load-file-as-text.js"></script>
    <script src="assets/js/main.js"></script>
    <script src="assets/js/moment.js"></script>
    <script src="assets/js/save-text-as-file.js"></script>
